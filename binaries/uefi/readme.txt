This is a copy of the README located in Rufus' `res/uefi` folder, which holds
the `uefi-ntfs.img` image.

This README and UEFI:NTFS image are up to date with commit:
https://github.com/pbatard/rufus/commit/2350489fe902bdc71d37f255a7684fe06a0ab2d0
